...
PDF_CLEANER_VERSION = 'pdf-1-pypdf-6.19.0'
...
QUESTION_RETRIEVAL_CHARS = 24000
QUESTION_RETRIEVAL_PASSAGES = 6
QUESTION_RETRIEVAL_TERMS = 12
QUESTION_RETRIEVAL_VERSION = 'question-fts-1'
QUESTION_STOP_WORDS = frozenset('a an and are as at be been by can could did do does for from had has have how i in is it its me my of on or our should that the their them there these they this those to was were what when where which who why will with would you your'.split())
